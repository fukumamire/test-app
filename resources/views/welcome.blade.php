  ...
  <div class="h-screen pb-14 bg-right bg-cover">
    <div class="container mx-auto pt-10 md:pt-18 px-6 lg:px-12 max-w-full flex flex-wrap flex-col md:flex-row items-center bg-yellow-50">
      ...
      <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden ">
        <h1 class="my-4 text-3xl md:text-5xl text-green-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">ペットの憩いの場</h1>
      ...
      <div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
        <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom rounded-lg shadow-xl" src="{{ asset('logo/inuneko.png') }}">
      </div>
    </div>
