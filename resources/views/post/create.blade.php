      ...
      @csrf
        <div class="md:flex items-center mt-8">
          <div class="w-full flex flex-col">
            ...
            <input type="text" name="title" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" value="{{old('title')}}"  placeholder="タイトルを２５５文字以内で記載してください">
          </div>
        </div>

        <div class="w-full flex flex-col">
          <label for="body" class="font-semibold leading-none mt-4">本文</label>
          <textarea name="body" class="w-auto py-2 placeholder-gray-300 order border-gray-300 rounded-md" id="body" cols="30" rows="10" placeholder="本文は１０００文字以内でお願います">{{old('body')}}</textarea>
        </div>
